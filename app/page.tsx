...
const experienceData: (ExperienceItem | InternshipGroupItem)[] = [
	...
	},
	{
		...
		imageURL: "/images/img_nagoya_univ.jpeg",
		labels: ["現在"],
	},
	{
		id: "exp-fristi",
	...
	},
	{
		...
		imageURL: "/images/img_l_is_b.jpeg",
	},
	{
		id: "exp-tu",
		...
		imageURL: "/images/img_tokushima_univ.jpg",
	},
	{
		id: "exp-whs",
...
const projectsData: ProjectItem[] = [
	...
	},
	{
		...
		title: "野球",
		description: "8歳から高校まで野球ばかりの毎日でした。イップスにより野球の道は諦めましたが、そのおかげで大学ではアプリ開発や映像制作といったクリエイティブなことの楽しさに出会うことができました!",
		tags: [
			"6",
			"遊撃手",
			"ショート",
